...
import time
import math
from RF24 import RF24, RF24_PA_LOW, RF24_PA_HIGH, RF24_DRIVER, RF24_PA_MAX, RF24_2MBPS, RF24_1MBPS, RF24_CRC_16
...
def slave_m(lcd):
    ...
    lcd.show_message_on_lcd("Press button \nto start")
    GPIO.output(leds.led_rojo, GPIO.HIGH)
    GPIO.output(leds.led_verde, GPIO.LOW)
